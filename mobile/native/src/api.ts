...
export type MobileQuestion = { _id: string; question: string; questionImage?: string | null; optionA: string; optionB: string; optionC: string; optionD: string; optionAImage?: string | null; optionBImage?: string | null; optionCImage?: string | null; optionDImage?: string | null; correctAnswer: 'A' | 'B' | 'C' | 'D'; subject: string; topic?: string | null; subtopic?: string | null; difficulty: 'Easy' | 'Medium' | 'Hard'; marks: number; explanation?: string | null };
